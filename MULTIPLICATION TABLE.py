print('Multiplication Table, by Abhishek kumar')
...
for number1 in range(0, 13):
    ...
    print(str(number1).rjust(2), end='') #  it converts the number1 variable to a string and right-aligns it with a width of 2
