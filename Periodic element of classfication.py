...
elements = list(elementsCsvReader) # represent a row of the data from the csvfile
elementsFile.close()
...
for line in elements:
    ...
    # Some of the data has bracketed text from Wikipedia that we want to remove,
    # such as the atomic weight of Boron: "10.81[III][IV][V][VI]" should be "10.81"
