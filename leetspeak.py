...
def englishToLeetspeak(message):
    ...
    charMapping = {
        ...
        'u': ['|_|'],
        'v': ['\\/']
    }   # we define a dictionary with key-value pair dictionary contain mapping for several character like a, c...etc which are used to convert english text to leetspeak
    leetspeak = ''
